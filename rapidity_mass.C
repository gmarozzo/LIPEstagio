void rapidity_mass(){
    ...
    Float_t proton_t[20], proton_pz[20], vertex_z[100], particle_e[20], particle_px[20], particle_py[20], particle_pz[20];
    ...
    for(int i = 0; i < tree->GetEntries(); i++){
        ...
        // create two lorentz vector for each muon of the pair
