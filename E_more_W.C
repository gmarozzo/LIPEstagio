void E_more_W(){
    ...
    for(int i = 0; i < tree->GetEntries(); i++){
        ...
        if( nback > 0 && nforw >0 ){
            if(nback == 1 && nforw == 1 && n_bosons == 2 && vertex_certo){
                //fill histogram of the Energy of the more energetic W bosons
    ...
    TCanvas *c3 = new TCanvas("c3", "Energy of the more energetic W bosons", 800, 600); 
    ...
    c3->SaveAs("Energy of the more energetic W bosons.pdf"); 
